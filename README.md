...
This game is best enjoyed by using a physical copy of the manual (download and print manual.pdf), however an online mobile-friendly version is also avalible at [manual.ericmcc.com](manual.ericmcc.com)
