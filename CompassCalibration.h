...
/*
  ...
  To use this for calibration:
  1. Uncomment the function call in setup()
  2. Rotate the compass slowly in a full circle
  3. Copy the printed calibration values
  4. Comment out the function call
*/
...
void runCompassCalibration() {
  ...
  Serial.println("\n--- COPY THESE INTO compass calibration ---");
